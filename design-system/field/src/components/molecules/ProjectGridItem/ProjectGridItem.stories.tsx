...
import {
  ...
  ProjectGridItem,
} from 'components/molecules/ProjectGridItem/ProjectGridItem'
...
const defaultValue: IProjectGridItemProps = {
  project,
}

export default {
  title: 'Molecules/ProjectGridItem',
...
const Template: Story<IProjectGridItemProps> = (args) => {
  return <ProjectGridItem {...args} />
}
...
const TemplateProcessing: Story<IProjectGridItemProps> = (args) => {
  return (

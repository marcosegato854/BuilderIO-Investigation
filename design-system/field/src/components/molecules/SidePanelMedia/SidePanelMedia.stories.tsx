...
import { SidePanelMedia, ISidePanelMediaProps } from './SidePanelMedia'
...
const defaultProps: ISidePanelMediaProps = {
  recordings: [
    {
      id: '001',
      title: 'Audio_001',
...
export default {
  title: 'Molecules/SidePanelMedia',
  component: SidePanelMedia,
...
const Template: Story<ISidePanelMediaProps> = (args) => {
  return <SidePanelMedia {...args} />
}

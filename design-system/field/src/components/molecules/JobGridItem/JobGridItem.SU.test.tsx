...
describe('JobGridItem SU (mockStore)', () => {
  ...
  beforeEach(() => {
    component = renderWithProvider(<JobGridItem job={jobWithSU} />)(mockedStore)
  })
...
describe('JobGridItem NO SU (mockStore)', () => {
  let component: RenderResult<typeof queries>
  ...
  beforeEach(() => {
    component = renderWithProvider(<JobGridItem job={jobWithoutSU} />)(
      mockedStore
    )
  })

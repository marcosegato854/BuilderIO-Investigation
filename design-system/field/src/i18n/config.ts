...
import en from 'i18n/mocks/en/translation.json'
import jp from 'i18n/mocks/jp/translation.json'
...
const backendOptions = {
  ...
  // TODO: get it from Node server in prod?
  // TODO: copy from dev to FieldWeb on release?
...
// TODO: could be better using __mock__ dir but it's giving problems
if (IS_TESTING) {
  const resources = {
    en: {
      translation: en,
  ...
  i18n
    ...
    .init({
      ...
      fallbackLng: 'en',
      react: {
        useSuspense: process.env.STORYBOOK !== 'true',
      },
